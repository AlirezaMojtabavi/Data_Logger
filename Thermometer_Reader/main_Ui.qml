        ...
        ScrollView{
            ...
            Column {
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged: if(checkBox1.checked){channel_selected(1)}
                    style: CheckBoxStyle {
                        label: Text {
                            color: "dark blue"
                            text: "Channel 1"
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged: if(checkBox2.checked){channel_selected(2)}
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged: if(checkBox3.checked){channel_selected(3)}
                    style: CheckBoxStyle {
                        label: Text {
                            color: "dark green"
                            text: "Channel 3"
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged: if(checkBox4.checked){channel_selected(4)}
                    style: CheckBoxStyle {
                        label: Text {
                            color: "deeppink"
                            text: "Channel 4"
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged: if(checkBox5.checked){channel_selected(5)}
                    style: CheckBoxStyle {
                        label: Text {
                            color: "olive"
                            text: "Channel 5"
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged: if(checkBox6.checked){channel_selected(6)}
                    style: CheckBoxStyle {
                        label: Text {
                            color: "dark orange"
                            text: "Channel 6"
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged: if(checkBox7.checked){channel_selected(7)}
                    style: CheckBoxStyle {
                        label: Text {
                            color: "dark violet"
                            text: "Channel 7"
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged: if(checkBox8.checked){channel_selected(8)}
                    style: CheckBoxStyle {
                        label: Text {
                            color: "darkcyan"
                            text: "Channel 8"
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged: if(checkBox9.checked){channel_selected(9)}
                    style: CheckBoxStyle {
                        label: Text {
                            color: "saddlebrown"
                            text: "Channel 9"
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged: if(checkBox10.checked){channel_selected(10)}
                    style: CheckBoxStyle {
                        label: Text {
                            color: "red"
                            text: "Channel 10"
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged:if(checkBox11.checked){channel_selected(11)}
                    style: CheckBoxStyle {
                        label: Text {
                            color: "springgreen"
                            opacity: 4
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged:if(checkBox12.checked){channel_selected(12)}
                    style: CheckBoxStyle {
                        label: Text {
                            color: "slategray"
                            text: "Channel 12"
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged:if(checkBox13.checked){channel_selected(13)}
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged:if(checkBox14.checked){channel_selected(14)}
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged: if(checkBox15.checked){channel_selected(15)}
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged: if(checkBox16.checked){channel_selected(16)}
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged: if(checkBox17.checked){channel_selected(17)}
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged: if(checkBox18.checked){channel_selected(18)}
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged: if(checkBox19.checked){channel_selected(19)}
                ...
                CheckBox {
                    ...
                    width: 95
                    height: 21
                    onCheckedChanged: if(checkBox20.checked){channel_selected(20)}
